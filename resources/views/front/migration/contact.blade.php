<div
class="social-contact-section pt-50 pb-50"
style="background-color: #9ae694"
>
<div class="container">
  <div class="row">
    <div
      class="
        col-lg-4 col-md-12
        order-2 order-md-2 order-sm-2 order-lg-1
      "
    >
      <!--=======  social media links  =======-->
      ...
      <div class="social-media-section">
        ...
        <div class="social-links">
          ...
          ></a>
          <a class="rss" href="http://www.rss.com/" data-tooltip="RSS"
            ><i class="fa fa-rss"></i
          ></a>
        </div>
      </div>
    ...
    <div
      class="
        col-lg-8 col-md-12
        order-1 order-md-1 order-sm-1 order-lg-2
        mb-sm-50 mb-xs-50
      "
    >
      <!--=======  contact summery  =======-->
      ...
      <div class="contact-summery">
        ...
        >
          ...
          <div class="single-contact d-flex mb-xs-20">
            ...
            <div class="contact-info">
              <p>Phone: <span>(+88) 01730588346</span></p>
            </div>
          </div>
...
<div
class="footer-navigation-section pt-40 pb-40"
style="background-color: #9ae694"
>
<div class="container">
  <div class="row">
