				...
				<div class="col">
					<div class="breadcrumb-container">
						<ul>
							...
							<li class="active">Forget password page</li>
						</ul>
					</div>
				</div>
			</div>
                            ...
                            <form id="frmForgot">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12 mb-20">
                                        ...
                                        <input class="mb-0" type="email" name="str_forgot_email" value="" placeholder="Email Address" required>
                                    </div>
                                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-12">
                                        <button id="btnForgot" class="register-button mt-0">Submit</button>
                                    </div>
