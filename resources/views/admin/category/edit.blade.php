                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <a href="{{asset('storage/media/category/'.$category_image)}}" target="_blank">
                                            <img width="50px" height="50px" src="{{asset('storage/media/category/'.$category_image)}}" alt="">
                                        </a>
                                        @endif
                                    </div>
                                    <div class="col-ms-6">
                                        ...
                                        <input id="is_home" type="checkbox" name="is_home" {{ $is_home_selected }}>
                                        {{-- @if($is_home==1)
                                            <input id="is_home" type="checkbox" name="is_home" checked>
                                        @else 
